...
#         review1 = Review.objects.create(review="This is the first review",
#         date='2021-12-31 09:00:00',)
#         review2 = Review.objects.create(name="Review2", date='2021-12-31 21:00:00', latitude=0.1, longitude=0.1)

#     def test_review_creation(self):
#         """Activities are being properly created"""
#         review1 = Review.objects.get(name="Review1")
#         review2 = Review.objects.get(name="Review2")
#         self.assertEqual(review1.name, 'Review1')
#         self.assertEqual(review2.name, 'Review2')

    # def test_get_valid_single_review(self):
    #     review1 = Review.objects.get(name="Review1")
    #     response = client.get(
    #         reverse('review-detail', kwargs={'pk': review1.pk})
    #         )
    #     review = Review.objects.get(pk=review1.pk)
